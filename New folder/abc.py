...
try:
    dfr1 = pd.read_csv(r'New folder/rules1_inoice.csv', index_col=0)
...
st.write("MOVIE NAMES:")
st.write(dfr1['antecedents'].value_counts())

# Load merged data
try:
    dfDF = pd.read_csv(r'New folder/rules1_inoice.csv')  # Adjust the path as needed
except FileNotFoundError:
